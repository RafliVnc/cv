        ...
        <div className="container">
          ...
          <div className="flex flex-col ">
            <div className="flex justify-end ">
              <div className="mb-10 p-4 relative lg:w-[70%]">
                ...
                <div className=" relative flex justify-center rounded-3xl shadow-md overflow-hidden ">
                  ...
                  <span className="w-full bottom-0 h-full z-10 gradient pl-2 absolute opacity-0 transition-all duration-300 hover:opacity-100">
                    <h1 className="absolute font-semibold bottom-4 z-20 text-Dark pl-2 mb-2 lg:text-xl md:pl-10 ">
                      Web Peta Kejahatan
                      <span className="block bottom-6 pt-1 font-light md:w-11/12">
                  ...
                  <span className="w-full bottom-0 h-full z-10 gradient pl-2 absolute opacity-0 transition-all duration-300 hover:opacity-100">
                    <h1 className="absolute font-semibold bottom-4 z-20 text-Dark pl-4 mb-2 lg:text-xl md:pl-10 ">
                      ...
                      <span className="block bottom-6 pt-1  font-light md:w-3/4">
                        Tampilan penggunan dari Crime Map Pekanbaru yang
                        berfungsi sebagai tampilan utama dari pengguna yang
                        mampu membirkan pin titik kejahatan serta tempat
                        menambahkan laporan. aplikasi berbasis web ini
                        dikembangkan menggunakan framework vue.
                      </span>
                    </h1>{" "}
                  </span>
                </div>
